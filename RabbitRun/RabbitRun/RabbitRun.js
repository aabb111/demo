var RabbitRun = function () {
   ...
   this.canvas = document.getElementById('RabbitRun-game-canvas');
   this.context = this.canvas.getContext('2d');
   this.fpsElement = document.getElementById('RabbitRun-fps');
   ...
   this.rulerCanvas = document.getElementById('RabbitRun-ruler-canvas');
   ...
   this.mobileStartToast =
      document.getElementById('RabbitRun-mobile-start-toast');

   this.mobileWelcomeToast =
      document.getElementById('RabbitRun-mobile-welcome-toast');

   this.welcomeStartLink =
      document.getElementById('RabbitRun-welcome-start-link');

   this.showHowLink =
      document.getElementById('RabbitRun-show-how-link');

   this.mobileStartLink =
      document.getElementById('RabbitRun-mobile-start-link');
   ...
   this.developerBackdoorElement =
      document.getElementById('RabbitRun-developer-backdoor');

   this.collisionRectanglesCheckboxElement =
      document.getElementById('RabbitRun-collision-rectangles-checkbox');

   this.detectRunningSlowlyCheckboxElement =
      document.getElementById('RabbitRun-detect-running-slowly-checkbox');

   this.smokingHolesCheckboxElement =
      document.getElementById('RabbitRun-smoking-holes-checkbox');

   this.runningSlowlyReadoutElement =
      document.getElementById('RabbitRun-running-slowly-readout');

   this.timeRateReadoutElement =
      document.getElementById('RabbitRun-time-rate-readout');
   ...
   this.musicElement = document.getElementById('RabbitRun-music');
   this.musicElement.volume = 0.1;

   this.musicCheckboxElement =
      document.getElementById('RabbitRun-music-checkbox');
   ...
   this.soundCheckboxElement =
      document.getElementById('RabbitRun-sound-checkbox');

   this.audioSprites =
      document.getElementById('RabbitRun-audio-sprites');
   ...
   this.livesElement = document.getElementById('RabbitRun-lives');

   this.lifeIconLeft =
      document.getElementById('RabbitRun-life-icon-left');

   this.lifeIconMiddle =
      document.getElementById('RabbitRun-life-icon-middle');

   this.lifeIconRight =
      document.getElementById('RabbitRun-life-icon-right');
   ...
   this.runningSlowlyElement =
      document.getElementById('RabbitRun-running-slowly');

   this.slowlyOkayElement =
      document.getElementById('RabbitRun-slowly-okay');

   this.slowlyDontShowElement =
      document.getElementById('RabbitRun-slowly-dont-show');

   this.slowlyWarningElement =
      document.getElementById('RabbitRun-slowly-warning');
   ...
   this.creditsElement =
      document.getElementById('RabbitRun-credits');

   this.playAgainLink =
      document.getElementById('RabbitRun-play-again-link');
   ...
   this.loadingElement = document.getElementById('RabbitRun-loading');

   this.loadingTitleElement =
      document.getElementById('RabbitRun-loading-title');

   this.loadingAnimatedGIFElement =
      document.getElementById('RabbitRun-loading-animated-gif');
   ...
   this.toastElement = document.getElementById('RabbitRun-toast');
   this.originalFont = this.toastElement.style.font;

   // Instructions......................................................

   this.instructionsElement =
      document.getElementById('RabbitRun-instructions');

   // Copyright.........................................................

   this.copyrightElement =
      document.getElementById('RabbitRun-copyright');

   // Score.............................................................

   this.scoreElement = document.getElementById('RabbitRun-score');

   // Sound and music...................................................

   this.soundAndMusicElement =
      document.getElementById('RabbitRun-sound-and-music');

   // Tweet score.......................................................

   this.tweetElement = document.getElementById('RabbitRun-tweet');
   ...
   this.platformArtist = {
      draw: function (sprite, context) {
         ...
         top = RabbitRun.calculatePlatformTop(sprite.track);
   ...
   this.paceBehavior = {
      setDirection: function (sprite) {
         ...
         if (sprite.direction === undefined) {
            sprite.direction = RabbitRun.RIGHT;
         }

         if (sRight > pRight && sprite.direction === RabbitRun.RIGHT) {
            sprite.direction = RabbitRun.LEFT;
         }
      ...
      setPosition: function (sprite, now, lastAnimationFrameTime) {
         ...
         if (sprite.direction === RabbitRun.RIGHT) {
   ...
   this.snailShootBehavior = { // sprite is the snail
      execute: function (sprite, now, fps, context,
         ...
         if ( ! RabbitRun.isSpriteInView(sprite)) {
            return;
         }
         ...
         if ( ! bomb.visible &&
            ...
            RabbitRun.playSound(RabbitRun.cannonSound);
         }
      }
   };
   ...
   this.blueButtonDetonateBehavior = {
      execute: function(sprite, now, fps, context,
         ...
         RabbitRun.explode(RabbitRun.bees[5]);

         setTimeout( function () {
            RabbitRun.explode(RabbitRun.bees[6]);
   ...
   this.goldButtonDetonateBehavior = {
      execute: function(sprite, now, fps, lastAnimationFrameTime) {
         ...
         RabbitRun.revealWinningAnimation();
   ...
   this.jumpBehavior = {
      ...
      finishDescent: function (sprite, now) {
         ...
         if (RabbitRun.platformUnderneath(sprite)) {
            sprite.top = sprite.verticalLaunchPosition;
         }
         else {
            sprite.fall(RabbitRun.GRAVITY_FORCE *
               (sprite.descendTimer.getElapsedTime(now)/1000) *
               RabbitRun.PIXELS_PER_METER);
         }
      },
   ...
   this.fallBehavior = {
      ...
      isOutOfPlay: function (sprite) {
         return sprite.top > RabbitRun.canvas.height;
      },

      setSpriteVelocity: function (sprite, now) {
         sprite.velocityY =
            sprite.initialVelocityY + RabbitRun.GRAVITY_FORCE *
      ...
      willFallBelowCurrentTrack: function (sprite, dropDistance) {
         return sprite.top + sprite.height + dropDistance >
                RabbitRun.calculatePlatformTop(sprite.track);
      },

      fallOnPlatform: function (sprite) {
         sprite.stopFalling();
         RabbitRun.putSpriteOnTrack(sprite, sprite.track);
         RabbitRun.playSound(RabbitRun.thudSound);
      },
      ...
      moveDown: function (sprite, now, lastAnimationFrameTime) {
         ...
         if ( ! this.willFallBelowCurrentTrack(sprite, dropDistance)) {
            ...
            if (RabbitRun.platformUnderneath(sprite)) { // collision detection
         ...
         if (sprite.falling) {
            if (! this.isOutOfPlay(sprite) && !sprite.exploding) {
               ...
               if (this.isOutOfPlay(sprite)) {
                  RabbitRun.loseLife();
                  RabbitRun.playSound(RabbitRun.electricityFlowingSound);
                  RabbitRun.runner.visible = false;
               }
            }
         }
         else { // Not falling
            if ( ! sprite.jumping &&
                 ! RabbitRun.platformUnderneath(sprite)) {
               sprite.fall();
            }
         }
      }
   ...
   this.collideBehavior = {
      adjustScore: function (sprite) {
         if (sprite.value) {
            RabbitRun.score += sprite.value;
            RabbitRun.updateScoreElement();
         }
      },
      ...
      didRunnerCollideWithSnailBomb: function (r, o, context) {
         ...
         context.beginPath();
         context.rect(r.left + RabbitRun.spriteOffset,
      ...
      processPlatformCollisionDuringJump: function (sprite, platform) {
         ...
         if (isDescending) {
            RabbitRun.putSpriteOnTrack(sprite, platform.track);
         }
         else {
            sprite.fall();
            RabbitRun.playSound(RabbitRun.thudSound);
      ...
      processBadGuyCollision: function (sprite) {
         RabbitRun.runner.stopFalling();
         RabbitRun.runner.stopJumping();
         RabbitRun.explode(sprite);
         RabbitRun.shake();
         RabbitRun.loseLife();
         },
      ...
      processAssetCollision: function (sprite) {
         ...
         if (sprite.type === 'coin') {
            RabbitRun.playSound(RabbitRun.coinSound);
         }
         else {
            RabbitRun.playSound(RabbitRun.pianoSound);
         }

         this.adjustScore(sprite);

         if (sprite.type === 'ruby')
            RabbitRun.scoreElement.style.color = 'blue';
         else if (sprite.type === 'sapphire')
            RabbitRun.scoreElement.style.color = 'red';
         else if (sprite.type === 'coin')
            RabbitRun.scoreElement.style.color = 'green';

         setTimeout( function () {
            RabbitRun.scoreElement.style.color = 'yellow';
         }, 100);
      },
      ...
      execute: function (sprite, now, fps, context,
         ...
         if ( ! RabbitRun.playing) {
            return;
         }

         for (var i=0; i < RabbitRun.sprites.length; ++i) {
            otherSprite = RabbitRun.sprites[i];
...
RabbitRun.prototype = {
   ...
   addSpritesToSpriteArray: function () {
      ...
      for (var i=0; i < this.smokingHoles.length; ++i) {
         RabbitRun.sprites.push(RabbitRun.smokingHoles[i]);
      }
   ...
   equipRunnerForJumping: function () {
      ...
      this.runner.jump = function () {
         ...
         this.ascendTimer.start(RabbitRun.timeSystem.calculateGameTime());
      };

      this.runner.stopJumping = function () {
         this.ascendTimer.stop(RabbitRun.timeSystem.calculateGameTime());
         this.descendTimer.stop(RabbitRun.timeSystem.calculateGameTime());
         this.runAnimationRate = RabbitRun.RUN_ANIMATION_RATE;
         this.jumping = false;
      };
   },
   ...
   equipRunnerForFalling: function () {
      ...
      this.runner.fall = function (initialVelocity) {
         ...
         this.fallTimer.start(
            RabbitRun.timeSystem.calculateGameTime());
      };
   ...
   equipRunner: function () {
      ...
      this.runner.direction = RabbitRun.LEFT;
   },
   ...
   setTimeRate: function (rate) {
      ...
      this.timeSystem.setTransducer( function (percent) {
         return percent * RabbitRun.timeRate;
      });
   },
   ...
   createSnailSprites: function () {
      ...
      for (var i = 0; i < this.snailData.length; ++i) {
         ...
         snail.velocityX = RabbitRun.SNAIL_PACE_VELOCITY;
   ...
   armSnails: function () {
      ...
      for (var i=0; i < this.snails.length; ++i) {
         ...
         snail.bomb.width  = RabbitRun.SNAIL_BOMB_CELLS_WIDTH;
         snail.bomb.height = RabbitRun.SNAIL_BOMB_CELLS_HEIGHT;
   ...
   draw: function (now) {
      ...
      if (this.mobileInstructionsVisible) {
         RabbitRun.drawMobileInstructions();
      }
   },
   ...
   checkFps: function (now) {
      ...
      this.updateSpeedSamples(RabbitRun.fps);
   ...
   resetSpeedSamples: function () {
      RabbitRun.speedSamples = [60,60,60,60,60,60,60,60,60,60]; // reset
   },
   ...
   platformUnderneath: function (sprite, track) {
      ...
      for (var i=0; i < RabbitRun.platforms.length; ++i) {
         platform = RabbitRun.platforms[i];
   ...
   turnRight: function () {
      ...
      this.runner.direction = RabbitRun.RIGHT;
   },
   ...
   fadeInElements: function () {
      ...
      setTimeout( function () {
         for (var i=0; i < args.length; ++i) {
            args[i].style.opacity = RabbitRun.OPAQUE;
         }
      }, this.SHORT_DELAY);
   },
   ...
   initializeDeveloperBackdoorSliders: function () {
      this.timeRateSlider.appendTo(
         'RabbitRun-time-rate-slider'
      );

      this.runningSlowlySlider.appendTo(
         'RabbitRun-running-slowly-slider'
      );
   ...
   shake: function () {
      var NUM_SHAKES = 12,
          ...
          velocity = RabbitRun.BACKGROUND_VELOCITY*1.5,
          originalVelocity = RabbitRun.bgVelocity,
          i = 0;

      reverseDirection = function () {
         RabbitRun.bgVelocity = i % 2 ? velocity : -velocity;
         ...
         if (i < NUM_SHAKES) {
            ...
            RabbitRun.bgVelocity = originalVelocity;
         }
      };
...
*/
   ...
   revealWinningAnimation: function () {
      ...
      setTimeout( function () {
         RabbitRun.loadingAnimatedGIFElement.style.display = 'none';
         RabbitRun.fadeInElements(RabbitRun.canvas);
         RabbitRun.gameOver();
   ...
   animate: function (now) {
      ...
      now = RabbitRun.timeSystem.calculateGameTime();

      if (RabbitRun.paused) {
         setTimeout( function () {
            requestNextAnimationFrame(RabbitRun.animate);
         }, RabbitRun.PAUSED_CHECK_INTERVAL);
      }
      else {
         RabbitRun.fps = RabbitRun.calculateFps(now);

         if (RabbitRun.windowHasFocus  &&
             RabbitRun.playing         &&
             RabbitRun.showSlowWarning &&
             now - RabbitRun.lastFpsCheckTime >
             RabbitRun.FPS_SLOW_CHECK_INTERVAL) {

            RabbitRun.checkFps(now);
            RabbitRun.lastFpsCheckTime = now;
         }

         RabbitRun.draw(now);
         RabbitRun.lastAnimationFrameTime = now;
         requestNextAnimationFrame(RabbitRun.animate);
      }
   },
   ...
   initializeImages: function () {
      ...
      this.spritesheet.onload = function (e) {
         RabbitRun.spritesheetLoaded();
      };

      this.loadingAnimatedGIFElement.onload = function () {
         RabbitRun.loadingAnimationLoaded();
      };
   },
   ...
   soundLoaded: function () {
      ...
      RabbitRun.audioSpriteCountdown--;

      if (RabbitRun.audioSpriteCountdown === 0) {
         if (!RabbitRun.gameStarted && RabbitRun.graphicsReady) {
            RabbitRun.startGame();
         }
      }
   },
      ...
      if (this.soundOn) {
         ...
         if (!channel) {
            ...
            setTimeout(function () {
               ...
               RabbitRun.seekAudio(sound, audio);
            }, sound.duration);
         }
      }
   },
   ...
   dimControls: function () {
      ...
      RabbitRun.instructionsElement.style.opacity = FINAL_OPACITY;
      RabbitRun.soundAndMusicElement.style.opacity = FINAL_OPACITY;
   },
   ...
   revealTopChromeDimmed: function () {
      ...
      setTimeout( function () {
         RabbitRun.scoreElement.style.opacity = DIM;
         RabbitRun.livesElement.style.opacity = DIM;
         RabbitRun.fpsElement.style.opacity = DIM;
      }, this.SHORT_DELAY);
   },
   ...
   revealGame: function () {
      ...
      setTimeout( function () {
         RabbitRun.dimControls();
         RabbitRun.revealTopChrome();
      }, DIM_CONTROLS_DELAY);
   },
   ...
   revealInitialToast: function () {
      ...
      setTimeout( function () {
         RabbitRun.revealToast('Collide with coins and jewels. ' +
           'Avoid bats and bees.',
           INITIAL_TOAST_DURATION);

           setTimeout( function () {
              RabbitRun.revealToast('Type CTRL-d to reveal the ' +
   ...
   processRightTap: function () {
      if (RabbitRun.runner.direction === RabbitRun.LEFT ||
          RabbitRun.bgVelocity === 0) {
         RabbitRun.turnRight();
      }
      else {
         RabbitRun.runner.jump();
      }
   },

   processLeftTap: function () {
      if (RabbitRun.runner.direction === RabbitRun.RIGHT) {
         RabbitRun.turnLeft();
      }
      else {
         RabbitRun.runner.jump();
   ...
   touchEnd: function (e) {
      ...
      if (RabbitRun.playing) {
         if (x < RabbitRun.canvas.width/2) {
            RabbitRun.processLeftTap();
         }
         else if (x > RabbitRun.canvas.width/2) {
            RabbitRun.processRightTap();
         }
   ...
   addTouchEventHandlers: function () {
      RabbitRun.canvas.addEventListener(
         'touchstart',
         RabbitRun.touchStart
      );
   ...
   revealMobileStartToast: function () {
      RabbitRun.fadeInElements(RabbitRun.mobileStartToast);
   },
   ...
   updateLivesElement: function () {
      if (this.lives === 3) {
         this.lifeIconLeft.style.opacity   = RabbitRun.OPAQUE;
         this.lifeIconMiddle.style.opacity = RabbitRun.OPAQUE;
         this.lifeIconRight.style.opacity  = RabbitRun.OPAQUE;
      }
      else if (this.lives === 2) {
         this.lifeIconLeft.style.opacity   = RabbitRun.OPAQUE;
         this.lifeIconMiddle.style.opacity = RabbitRun.OPAQUE;
         this.lifeIconRight.style.opacity  = RabbitRun.TRANSPARENT;
      }
      else if (this.lives === 1) {
         this.lifeIconLeft.style.opacity   = RabbitRun.OPAQUE;
         this.lifeIconMiddle.style.opacity = RabbitRun.TRANSPARENT;
         this.lifeIconRight.style.opacity  = RabbitRun.TRANSPARENT;
      }
      else if (this.lives === 0) {
         this.lifeIconLeft.style.opacity   = RabbitRun.TRANSPARENT;
         this.lifeIconMiddle.style.opacity = RabbitRun.TRANSPARENT;
         this.lifeIconRight.style.opacity  = RabbitRun.TRANSPARENT;
      }
   },
   ...
   pollMusic: function () {
      ...
      timerID = setInterval( function () {
         if (RabbitRun.musicElement.currentTime > SOUNDTRACK_LENGTH) {
            clearInterval(timerID);   // Stop polling
            RabbitRun.restartMusic(); // Restarts music and polling
         }
      }, POLL_INTERVAL);
   },

   restartMusic: function () {
      RabbitRun.musicElement.pause();
      RabbitRun.musicElement.currentTime = 0;

      RabbitRun.startMusic(); // Calls pollMusic() after 1s delay
   },
   ...
   startMusic: function () {
      ...
      setTimeout( function () {
         if (RabbitRun.musicCheckboxElement.checked) {
            RabbitRun.musicElement.play();
         }
   ...
   startGame: function () {
      ...
      if (RabbitRun.mobile) {
         this.fadeInElements(RabbitRun.mobileWelcomeToast);
      }
      else {
   ...
   resetRunner: function () {
      this.runner.left      = RabbitRun.RUNNER_LEFT;
      this.runner.track     = 3;
   ...
   startLifeTransition: function (delay) {
      ...
      setTimeout( function () {
         RabbitRun.setTimeRate(SLOW_MOTION_RATE);
         RabbitRun.runner.visible = false;
      }, delay);
   },
   ...
   endLifeTransition: function () {
      ...
      setTimeout( function () { // Reset the time
         RabbitRun.setTimeRate(1.0);

         setTimeout( function () { // Stop running
            RabbitRun.runner.runAnimationRate = 0;
         }, RUN_DELAY);
      }, TIME_RESET_DELAY);
   },
   ...
   loseLife: function () {
      ...
      if (this.runner.exploding) {
         this.startLifeTransition(RabbitRun.RUNNER_EXPLOSION_DURATION);
         transitionDuration += RabbitRun.RUNNER_EXPLOSION_DURATION;
      }
      else {
   ...
   detectMobile: function () {
      RabbitRun.mobile = 'ontouchstart' in window;
   },
   ...
   resizeElementsToFitScreen: function (arenaWidth, arenaHeight) {
      RabbitRun.resizeElement(
         document.getElementById('RabbitRun-arena'),
         arenaWidth, arenaHeight);

      RabbitRun.resizeElement(RabbitRun.mobileWelcomeToast,
                              arenaWidth, arenaHeight);

      RabbitRun.resizeElement(RabbitRun.mobileStartToast,
                              arenaWidth, arenaHeight);
   },
   ...
   fitScreen: function () {
      var arenaSize = RabbitRun.calculateArenaSize(
                         RabbitRun.getViewportSize());

      RabbitRun.resizeElementsToFitScreen(arenaSize.width,
                                          arenaSize.height);
   },
...
window.addEventListener('keydown', function (e) {
   ...
   if (key === 68 && e.ctrlKey) { // CTRL-d
      if ( ! RabbitRun.developerBackdoorVisible) {
         RabbitRun.revealDeveloperBackdoor();
      }
      else {
         RabbitRun.hideDeveloperBackdoor();
      }
      return;
   }

   if ( ! RabbitRun.playing || RabbitRun.runner.exploding) {
      return;
   }

   if (key === 83 && e.shiftKey) { // 'S' key
      if (RabbitRun.timeRate === RabbitRun.NORMAL_TIME_RATE) {
         RabbitRun.setTimeRate(SLOW_MOTION_RATE);
      }
      else if (RabbitRun.timeRate === SLOW_MOTION_RATE) {
         RabbitRun.setTimeRate(RabbitRun.NORMAL_TIME_RATE);
      }
   }
   else if (key === 83) { // 's' key
      if ( ! RabbitRun.stalled) {
         RabbitRun.previousBgVelocity = RabbitRun.bgVelocity;
         RabbitRun.bgVelocity = 0;
         RabbitRun.stalled = true;
      }
      else {
         RabbitRun.stalled = false;
         RabbitRun.bgVelocity = RabbitRun.previousBgVelocity;
      }
   }
...
window.addEventListener(
   ...
   function (e) {
      if (!RabbitRun.gameStarted) return;

      RabbitRun.windowHasFocus = false;

      if ( ! RabbitRun.paused) {
         RabbitRun.togglePaused(); // pause if not paused
      }
   }
);
...
window.addEventListener(
   ...
   function (e) {
      var DIGIT_DISPLAY_DURATION = 1000, // milliseconds
          takeAction = function () {
             return RabbitRun.windowHasFocus &&
                    RabbitRun.countdownInProgress;
             };

      if (!RabbitRun.gameStarted) return;

      RabbitRun.windowHasFocus = true;

      if (!RabbitRun.playing) {
        RabbitRun.togglePaused();
      }
      else if (RabbitRun.paused) {
         RabbitRun.countdownInProgress = true;
         RabbitRun.toastElement.style.font = '128px fantasy';

         if (takeAction()) {
            RabbitRun.revealToast('3', 500);

            setTimeout(function (e) {
               if (takeAction()) {
                  RabbitRun.revealToast('2', 500);
               }

               setTimeout(function (e) {
                  if (takeAction()) {
                     RabbitRun.revealToast('1', 500);
                  }

                  setTimeout(function (e) {
                     if (takeAction()) {
                        RabbitRun.togglePaused();
                        RabbitRun.toastElement.style.font =
                           RabbitRun.originalFont;
                     }

                     RabbitRun.countdownInProgress = false;
...
var RabbitRun = new RabbitRun();

RabbitRun.playAgainLink.addEventListener(
   'click',

   function (e) {
      RabbitRun.restartGame();
   }
);

// Developer backdoor event handlers...................................

RabbitRun.collisionRectanglesCheckboxElement.addEventListener(
   'change',

   function (e) {
      var show = RabbitRun.collisionRectanglesCheckboxElement.checked;

      for (var i=0; i < RabbitRun.sprites.length; ++i) {
         RabbitRun.sprites[i].showCollisionRectangle = show;
      }
   }
);

RabbitRun.detectRunningSlowlyCheckboxElement.addEventListener(
   'change',

   function (e) {
      RabbitRun.showSlowWarning =
         RabbitRun.detectRunningSlowlyCheckboxElement.checked;
   }
);

RabbitRun.smokingHolesCheckboxElement.addEventListener(
   'change',

   function (e) {
      RabbitRun.showSmokingHoles =
         RabbitRun.smokingHolesCheckboxElement.checked;
   }
);

RabbitRun.runningSlowlySlider.addChangeListener(function (e) {
   var threshold =
      (RabbitRun.runningSlowlySlider.knobPercent *
         RabbitRun.MAX_RUNNING_SLOWLY_THRESHOLD).toFixed(0);

   RabbitRun.runningSlowlyThreshold = threshold;
   RabbitRun.runningSlowlyReadoutElement.innerHTML = threshold;
});

RabbitRun.timeRateSlider.addChangeListener(function (e) {
   if (RabbitRun.timeRateSlider.knobPercent < 0.01) {
      RabbitRun.timeRateSlider.knobPercent = 0.01;
   }

   RabbitRun.setTimeRate(RabbitRun.timeRateSlider.knobPercent *
                        (RabbitRun.MAX_TIME_RATE));

   RabbitRun.timeRateReadoutElement.innerHTML =
      (RabbitRun.timeRate * 100).toFixed(0);
});

// Running slowly warning event handlers..............................

RabbitRun.slowlyDontShowElement.addEventListener(
   'click',

   function (e) {
      RabbitRun.fadeOutElements(RabbitRun.runningSlowlyElement,
                                RabbitRun.RUNNING_SLOWLY_FADE_DURATION);
      RabbitRun.showSlowWarning = false;
      RabbitRun.updateDeveloperBackdoorCheckboxes();
   }
);

RabbitRun.slowlyOkayElement.addEventListener(
   'click',

   function (e) {
      RabbitRun.fadeOutElements(RabbitRun.runningSlowlyElement,
                                RabbitRun.RUNNING_SLOWLY_FADE_DURATION);
      RabbitRun.resetSpeedSamples();
   }
);

// Sound and music checkbox event handlers.............................

RabbitRun.musicCheckboxElement.addEventListener(
   'change',

   function (e) {
      RabbitRun.musicOn = RabbitRun.musicCheckboxElement.checked;

      if (RabbitRun.musicOn) {
         RabbitRun.musicElement.play();
      }
      else {
         RabbitRun.musicElement.pause();
...
RabbitRun.soundCheckboxElement.addEventListener(
   'change',

   function (e) {
      RabbitRun.soundOn = RabbitRun.soundCheckboxElement.checked;
   }
);
...
RabbitRun.canvas.addEventListener(
   ...
   function (e) {
      if (RabbitRun.developerBackdoorVisible) {
         RabbitRun.startDraggingGameCanvas(e);
      }
   }
);
...
RabbitRun.canvas.addEventListener(
   ...
   function (e) {
      if (RabbitRun.developerBackdoorVisible && RabbitRun.dragging) {
         RabbitRun.dragGameCanvas(e);
      }
   }
);
...
window.addEventListener(
   ...
   function (e) {
      if (RabbitRun.developerBackdoorVisible) {
         RabbitRun.stopDraggingGameCanvas();
      }
   }
);

RabbitRun.showHowLink.addEventListener(
   'click',

   function (e) {
      var FADE_DURATION = 1000;

      RabbitRun.fadeOutElements(RabbitRun.mobileWelcomeToast,
                                FADE_DURATION);

      RabbitRun.drawMobileInstructions();
      RabbitRun.revealMobileStartToast();
      RabbitRun.mobileInstructionsVisible = true;
   }
);

RabbitRun.mobileStartLink.addEventListener(
   'click',

   function (e) {
      var FADE_DURATION = 1000;

      RabbitRun.fadeOutElements(RabbitRun.mobileStartToast,
                                FADE_DURATION);

      RabbitRun.mobileInstructionsVisible = false;
      RabbitRun.playSound(RabbitRun.coinSound);
      RabbitRun.playing = true;
   }
);

RabbitRun.welcomeStartLink.addEventListener(
   'click',
...
RabbitRun.initializeImages();
RabbitRun.createSprites();
RabbitRun.createAudioChannels();
RabbitRun.drawRuler();

RabbitRun.detectMobile();

if (RabbitRun.mobile) {
   RabbitRun.DEFAULT_RUNNING_SLOWLY_THRESHOLD = 30; // fps

   RabbitRun.instructionsElement =
      document.getElementById('RabbitRun-mobile-instructions');

   RabbitRun.addTouchEventHandlers();

   if (/android/i.test(navigator.userAgent)) {
      RabbitRun.cannonSound.position = 5.4;
      RabbitRun.coinSound.position = 4.8;
      RabbitRun.electricityFlowingSound.position = 0.3;
      RabbitRun.explosionSound.position = 2.8;
      RabbitRun.pianoSound.position = 3.5;
      RabbitRun.thudSound.position = 1.8;
   }
}

RabbitRun.fitScreen();
window.addEventListener("resize", RabbitRun.fitScreen);
window.addEventListener("orientationchange", RabbitRun.fitScreen);
